    ...
    this.$SectionNavigator.innerHTML = `
          ...
          <li class="section-navigator-item">
            ...
            <label class="section-navigator-item-label" for="section-navigator-item-input-cards">
              <svg class="side-icon" id="Capa_1" enable-background="new 0 0 512 512" height="512" viewBox="0 0 512 512" width="512" xmlns="http://www.w3.org/2000/svg"><g><path d="m467 76h-422c-24.813 0-45 20.187-45 45v270c0 24.813 20.187 45 45 45h422c24.813 0 45-20.187 45-45v-270c0-24.813-20.187-45-45-45zm15 315c0 8.271-6.729 15-15 15h-422c-8.271 0-15-6.729-15-15v-270c0-8.271 6.729-15 15-15h422c8.271 0 15 6.729 15 15z"/><path d="m436 136h-120c-8.284 0-15 6.716-15 15s6.716 15 15 15h120c8.284 0 15-6.716 15-15s-6.716-15-15-15z"/><path d="m436 196h-120c-8.284 0-15 6.716-15 15s6.716 15 15 15h120c8.284 0 15-6.716 15-15s-6.716-15-15-15z"/><path d="m436 286h-20c-8.284 0-15 6.716-15 15s6.716 15 15 15h20c8.284 0 15-6.716 15-15s-6.716-15-15-15z"/><path d="m286 316h70c8.284 0 15-6.716 15-15s-6.716-15-15-15h-70c-8.284 0-15 6.716-15 15s6.716 15 15 15z"/><path d="m436 346h-150c-8.284 0-15 6.716-15 15s6.716 15 15 15h150c8.284 0 15-6.716 15-15s-6.716-15-15-15z"/><path d="m196 196h-45v-45c0-8.284-6.716-15-15-15h-60c-8.284 0-15 6.716-15 15v60c0 8.284 6.716 15 15 15h45v45c0 8.284 6.716 15 15 15h60c8.284 0 15-6.716 15-15v-60c0-8.284-6.716-15-15-15zm-105-30h30v30h-30zm90 90h-30v-30h30z"/><path d="m196 346h-120c-8.284 0-15 6.716-15 15s6.716 15 15 15h120c8.284 0 15-6.716 15-15s-6.716-15-15-15z"/></g></svg>
              <div class="section-navigator-item-label-text">
                결제 수단 관리
              </div>
            </label>
